...
from agents import market_research_analyst,reporting_analyst,financial_analyst
...
reporting_analysis=Task(
    ...
    expected_output="A detailed 1 page report that combines financial performance analysis with market trends and competitive analysis for {company}, all important findings should be highlighted and formatted as a .docx",
    tools=[tool],
